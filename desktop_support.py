...
class support:
    ...
    def add_button(self):
        ...
        button1=Sbutton(self.root,text="brightness +",command=self.increase_brightness)
        button1.grid(column=0,row=1)
        button2=Sbutton(self.root,text="brightness -",command=self.decrease_bringtness)
        button2.grid(row=1,column=1)
        button3=Sbutton(self.root,text="wifi on",command=self.wifi_on)
        button3.grid(row=1,column=2)
        button4=Sbutton(self.root,text="wifi off",command=self.wifi_off)
        button4.grid(row=1,column=3)
        button5=Sbutton(self.root,text="wifi list",command=self.show_wifi_list)
        button5.grid(row=1,column=4)
        label2=Label(text="display")
        label2.grid(row=2,column=0)
        button6=Sbutton(self.root,text="laptop",)
        button6.grid(row=3,column=0)
        button7=Sbutton(self.root,text="hdmi")
        button7.grid(row=3,column=1)
        button8=Sbutton(self.root,text="both")
        button8.grid(row=3,column=2)
        button9=Sbutton(self.root,text="mirror")
        button9.grid(row=3,column=3)
        label3=Label(text="sound")
        label3.grid(row=4,column=0)
        button10=Sbutton(self.root,text="volume +",command=self.increase_volume)  
        button10.grid(row=5,column=0)
        button11=Sbutton(self.root,text="volume -",command=self.decrease_volume)
        button11.grid(row=5,column=1)
        button12=Sbutton(self.root,text="mute/unmute",command=self.mute)

        button12.grid(row=5,column=2)
        
        label4=Label(text="keyboard")
        label4.grid(row=6,column=0)
        button13=Sbutton(self.root,text="caps lock",command=self.caps_lock)
        button13.grid(row=7,column=0)
        button14=Sbutton(self.root,text="num lock")
        button14.grid(row=7,column=1)
        button15=Sbutton(self.root,text="scroll lock")
